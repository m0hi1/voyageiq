  ...
  const validateForm = () => {
    ...
    if (formData.newPassword) {
      ...
      if (formData.newPassword.length < 6) {
        ...
        isValid = false;
      } else if (!/\d/.test(formData.newPassword) || !/[a-zA-Z]/.test(formData.newPassword)) {
...
font-bold
text-slate-800\>Edit Profile</h2>
          <button
            type=\button\
            onClick={handleClose}
            className=\text-slate-500
...
focus:border-transparent\
            />
            {errors.username && (
              <p className=\text-red-500
text-sm
mt-1\>{errors.username}</p>
            )}
          </div>
...
text-xs
mt-1\>Email cannot be changed for Google accounts</p>
            )}
            {errors.email && (
              <p className=\text-red-500
text-sm
...
text-slate-700
mb-2\>Change Password (Optional)</h3>
...
focus:border-transparent\
                  ...
                  {errors.currentPassword && (
                    <p className=\text-red-500
text-sm
mt-1\>{errors.currentPassword}</p>
                  )}
                </div>
                
                <div className=\mb-3\>
                  <label htmlFor=\newPassword\ className=\block
text-sm
font-medium
text-slate-700
mb-1\>
...
h-4
w-4
text-white\ xmlns=\http://www.w3.org/2000/svg\ fill=\none\ viewBox=\0
0
24
24\>
