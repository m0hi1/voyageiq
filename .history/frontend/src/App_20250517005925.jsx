...
// Router future flags are enabled to address React Router v7 warnings
...
function App() {
  return (
    <GlobalErrorBoundary>      <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
