        ...
        <DialogContent className="max-w-sm rounded-xl p-0 bg-white overflow-hidden">
          ...
          <DialogHeader className="text-center p-6 pb-2">
            <DialogTitle className="text-2xl font-bold mb-2 text-indigo-700">
              Let&apos;s Get Started
            </DialogTitle>            {/* Changed DialogDescription to div to avoid nesting paragraph errors */}
            <div className="flex flex-col items-center space-y-4 text-muted-foreground text-sm">
              ...
              <div className="text-gray-600">Sign in to create and save your personalized trip itinerary</div>
              <GoogleLoginButton 
                onLoginSuccess={() => {
                  setOpenDailog(false);
                  setTimeout(() => {
