      ...
      <div className="max-w-[1170px] py-4 px-5 mx-auto">
        <div className="grid md:grid-cols-3 gap-10">
          <div className="py-[50px] px-[30px] rounded-md">
            <div className="flex items-center justify-center">              <figure className="w-[100px] h-[100px] rounded-full border-2 border-solid border-Color overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = defaultAvatar; // Use the fallback image
                  }}
                />
              </figure>
            </div>
